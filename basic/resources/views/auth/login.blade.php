              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Email" name="email" required autofocus>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">{{ __('Sign in') }}</button>
